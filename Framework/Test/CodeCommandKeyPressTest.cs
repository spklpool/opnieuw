...
{
	[TestFixture]
	public class CodeCommandKeyPressTest : Assertion
	{
		[Test]
		public void TestDoUndo1()
		{
			...
			processor.Do(new CodeCommandKeyPress(c, 'b'));

			Assertion.AssertEquals("After Do : StartLine is wrong!", 1, c.Selection.StartLine);
			Assertion.AssertEquals("After Do : StartCol is wrong!", 4, c.Selection.StartCol);
			Assertion.AssertEquals("After Do : EndLine is wrong!", 1, c.Selection.EndLine);
			Assertion.AssertEquals("After Do : EndCol is wrong!", 4, c.Selection.EndCol);
			string expected = "libe1\r\n";
			...
			Assertion.AssertEquals("After Redo : StartCol is wrong!", 4, c.Selection.StartCol);
			Assertion.AssertEquals("After Redo : EndLine is wrong!", 1, c.Selection.EndLine);
			Assertion.AssertEquals("After Redo : EndCol is wrong!", 4, c.Selection.EndCol);
			expected = "libe1\r\n";
			Assertion.AssertEquals("Text after redo is wrong", expected, c.Text);
		}
		[Test]
		public void TestDoUndo2()
		{
			...
			CodeCommandProcessor processor = new CodeCommandProcessor();
			processor.Do(new CodeCommandKeyPress(c, 'k'));
			...
			Assertion.AssertEquals("After Undo : StartLine is wrong!", 1, c.Selection.StartLine);
			Assertion.AssertEquals("After Undo : StartCol is wrong!", 2, c.Selection.StartCol);
			Assertion.AssertEquals("After Undo : EndLine is wrong!", 1, c.Selection.EndLine);
			Assertion.AssertEquals("After Undo : EndCol is wrong!", 5, c.Selection.EndCol);
			expected = "line1\r\n";
			Assertion.AssertEquals("Text after undo is wrong", expected, c.Text);
			...
			Assertion.AssertEquals("After Redo : StartLine is wrong!", 1, c.Selection.StartLine);
			Assertion.AssertEquals("After Redo : StartCol is wrong!", 3, c.Selection.StartCol);
			Assertion.AssertEquals("After Redo : EndLine is wrong!", 1, c.Selection.EndLine);
			Assertion.AssertEquals("After Redo : EndCol is wrong!", 3, c.Selection.EndCol);
			expected = "lk1\r\n";
			Assertion.AssertEquals("Text after redo is wrong", expected, c.Text);
		}

		[Test]
		public void TestDoUndo3()
		{
			//li[]ne1
			TestCode c = new TestCode("line1\r\n");
			c.Selection.StartLine = 1;
		...
		public void TestDoUndoWithTab()
		{
			...
			CodeCommandProcessor processor = new CodeCommandProcessor();
			processor.Do(new CodeCommandKeyPress(c, '\t'));

			Assertion.AssertEquals("After Do : StartLine is wrong!", 1, c.Selection.StartLine);
			Assertion.AssertEquals("After Do : StartCol is wrong!", 5, c.Selection.StartCol);
			Assertion.AssertEquals("After Do : EndLine is wrong!", 1, c.Selection.EndLine);
			Assertion.AssertEquals("After Do : EndCol is wrong!", 5, c.Selection.EndCol);
			string expected = "li\tne1\r\n";
			Assertion.AssertEquals("Text after do is wrong", expected, c.Text);
			...
			Assertion.AssertEquals("After Redo : StartLine is wrong!", 1, c.Selection.StartLine);
			Assertion.AssertEquals("After Redo : StartCol is wrong!", 5, c.Selection.StartCol);
			Assertion.AssertEquals("After Redo : EndLine is wrong!", 1, c.Selection.EndLine);
			Assertion.AssertEquals("After Redo : EndCol is wrong!", 5, c.Selection.EndCol);
			expected = "li\tne1\r\n";
			Assertion.AssertEquals("Text after undo is wrong", expected, c.Text);
		}
	}
