...
namespace Opnieuw.UI.TreeBrowser
{
	...
	public class MultiSelectableTreeView : TreeView
	{
		...
		private void InitializeComponent() 
		{
            ...
            this.KeyDown += new System.Windows.Forms.KeyEventHandler(this.CodeTreeView_KeyDown);
		}
        ...
        protected void CodeTreeView_KeyDown(object sender, System.Windows.Forms.KeyEventArgs e) 
        {
            if ((m_coll.Count == 1)) {
                if (e.KeyCode == Keys.Right) {
                    TreeNode node = (TreeNode)m_coll[0];
                    node.Expand();
