...
namespace Opnieuw.UI.TreeBrowser
{
	...
	public class Browser : System.Windows.Forms.UserControl
	{
		...
		private void LoadRefactoring(OpnieuwConfiguration.RefactoringRow refactoringRow)
		{
			try
			{
				Assembly assem = Assembly.Load(refactoringRow.AssemblyName);
				...
				if (objGUI is RefactoringGUI)
				{
                    ...
                    try {
                        ResourceManager rm = new System.Resources.ResourceManager(refactoringRow.Name + ".images", assem);
                        if (rm == null) {
                            rm = new System.Resources.ResourceManager("images", assem);
                        }
...
// 
            ...
            ResourceManager rm = new System.Resources.ResourceManager("BrowserApp.images", Assembly.GetExecutingAssembly());
            try {
